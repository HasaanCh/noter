...
export default class NoteList extends Component
{
    ...
    componentDidMount() {
        ...
        if(aloo)
        {
            ...
            axios.get('https://backendprojectnoter.herokuapp.com/notes/email/'+aloo.email).then(response =>{
    ...
    addnew()
    {
        ...
        var newnote=axios.post('https://backendprojectnoter.herokuapp.com/notes/add/', {
                        ...
                        const printAddress = () => {
                            ...
                            // axios.get('https://backendprojectnoter.herokuapp.com/notes/email/'+this.state.email).then(response =>{
    ...
    {
        this.hideModal();
        axios.delete('https://backendprojectnoter.herokuapp.com/notes/'+id).then(res=> console.log(res.data));
        this.setState({
    ...
    myChangeHandler =  (event) => {
            ...
            axios.post('https://backendprojectnoter.herokuapp.com/notes/update/'+this.state.noteid, {
            "username": this.state.noteuser,
